...
void menu_advanced_settings() {
  ...
  BACK_ITEM(MSG_CONFIGURATION);
		...
		//
		#if HAS_OFFSET_MENU
		EDIT_ITEM(float42_52, MSG_X_HOME_OFFSET, &home_offset[X_AXIS], -30.0f, 30.0f);
		EDIT_ITEM(float42_52, MSG_Y_HOME_OFFSET, &home_offset[Y_AXIS], -30.0f, 30.0f);
		EDIT_ITEM(float42_52, MSG_Z_HOME_OFFSET, &home_offset[Z_AXIS], -30.0f, 30.0f);
		#else		
