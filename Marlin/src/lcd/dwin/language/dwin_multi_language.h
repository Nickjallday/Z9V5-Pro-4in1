...
uint16_t Print_X_Coordinate[Lang_Number] = {53,36,44,35,30};
uint16_t Prepare_X_Coordinate[Lang_Number] = {172,165,150,168,164};
uint16_t Control_X_Coordinate[Lang_Number] = {44,44,27,37,36};
uint16_t StartInfo_X_Coordinate[Lang_Number] = {184,184,160,182,185};
uint16_t Tune_X_Coordinate[Lang_Number] = {32,19,25,23,24};
uint16_t Pause_X_Coordinate[Lang_Number] = {116,104,114,116,110};
uint16_t Continue_X_Coordinate[Lang_Number] = {117,101,107,107,105};
uint16_t Stop_X_Coordinate[Lang_Number] = {208,189,204,208,196};
uint16_t Print_File_X_Coordinate[Lang_Number] = {49,81,62,79,87};
uint16_t Home_X_Coordinate[Lang_Number] = {52,59,62,59,65};
uint16_t Point_X_Coordinate[Lang_Number] = {47,51,54,43,54};
uint16_t Catch_X_Coordinate[Lang_Number] = {48,67,69,73,76};
uint16_t Bed_X_Coordinate[Lang_Number] = {33,49,52,21,40};
uint16_t Auto_X_Coordinate[Lang_Number] = {43,49,52,21,40};
uint16_t Max_X_Coordinate[Lang_Number] = {38,38,38,38,38};
uint16_t Feedrate_X_Coordinate[Lang_Number] = {73,59,78,59,87};
uint16_t Accel_X_Coordinate[Lang_Number] = {46,70,95,97,91};
uint16_t Jerk_X_Coordinate[Lang_Number] = {39,38,62,34,55};
uint16_t Step_X_Coordinate[Lang_Number] = {79,90,114,65,89};
uint16_t Extruder_X_Coordinate[Lang_Number] = {72,93,105,79,68};
uint16_t Comit_X_Coordinate[Lang_Number] = {54,63,96,113,52};
uint16_t Start_X_Coordinate[Lang_Number] = {44,52,65,50,52};
uint16_t End_X_Coordinate[Lang_Number] = {32,93,100,24,33};
uint16_t Current_X_Coordinate[Lang_Number] = {65,74,78,95,46};
uint16_t Hotend_X_Coordinate[Lang_Number] = {64,48,56,41,38};
uint16_t Probe_X_Coordinate[Lang_Number] = {52,43,114,61,53};
uint16_t Move_X_Coordinate[Lang_Number] = {49,55,93,71,55};
uint16_t Preheat_X_Coordinate[Lang_Number] = {66,66,66,50,100};
uint16_t Store_X_Coordinate[Lang_Number] = {51,70,74,68,92};
uint16_t Load_X_Coordinate[Lang_Number] = {44,59,76,59,51};
//uint16_t Power_X_Coordinate[Lang_Number] = {51,54,71,54,46};

enum Picture_Item : uint8_t {
	Picture_Print,
	Picture_Prepare,
	Picture_Control,
	Picture_StartInfo,
...
uint16_t Picture_Coordinate[Lang_Number][8] ={
 ...
 */ 								 
uint16_t Menu_Coordinate[Lang_Number][Item_Number][4] ={
{	{1,  391,39, 404},										//main					//EN
